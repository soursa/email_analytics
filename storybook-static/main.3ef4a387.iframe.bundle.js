  ...
  [179],
  {
    './config/storybook/preview.ts': (
      ...
      const storybook_preview = {
        ...
        decorators: [
          StyleDecorator,
          (0, ThemeDecorator_.F)(ThemeProvider.Q2.LIGHT),
          RouterDecorator,
        ],
      };
    },
    ...
    './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[13].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/app/styles/index.scss':
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          '*{margin:0;padding:0;box-sizing:border-box}input,button,textarea,select{margin:0;font:inherit}:root{--font-family-main: consolas, "Times New Roman";--font-size-m: 16px;--font-line-m: 24px;--font-m: var(--font-size-m) / var(--font-line-m) var(--font-family-main);--font-size-l: 24px;--font-line-l: 32px;--font-l: var(--font-size-l) / var(--font-line-l) var(--font-family-main);--navbar-heigth: 50px}.app.light{--bg-color: #DCDCDC;--inverted-bg-color: #474A51;--primary-color: #333030;--inverted-primary-color: #C3CBDE;--secondary-color: #4A4342;--inverted-secondary-color: #CBE3F5}.app.dark{--bg-color: #474A51;--inverted-bg-color: #DCDCDC;--primary-color: #C3CBDE;--inverted-primary-color: #333030;--secondary-color: #CBE3F5;--inverted-secondary-color: #4A4342}a{color:var(--primary-color)}.app{font:var(--font-m);background:var(--bg-color);min-height:100vh}.content-page{display:flex;height:100%}.page-wrapper{flex-grow:1;padding:20px}',
          '',
          {
            version: 3,
            sources: [
            ...
            names: [],
            mappings:
              'AAAA,EACE,QAAA,CACA,SAAA,CACA,qBAAA,CAGF,6BAIE,QAAA,CACA,YAAA,CCXF,MACE,+CAAA,CACA,mBAAA,CACA,mBAAA,CACA,yEAAA,CACA,mBAAA,CACA,mBAAA,CACA,yEAAA,CAGA,qBAAA,CCVF,WACE,mBAAA,CACA,4BAAA,CACA,wBAAA,CACA,iCAAA,CACA,0BAAA,CACA,mCAAA,CCNF,UACE,mBAAA,CACA,4BAAA,CACA,wBAAA,CACA,iCAAA,CACA,0BAAA,CACA,mCAAA,CCDF,EACE,0BAAA,CAGF,KACE,kBAAA,CACA,0BAAA,CACA,gBAAA,CAGF,cACE,YAAA,CACA,WAAA,CAGF,cACE,WAAA,CACA,YAAA',
            sourcesContent: [
              '* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\ninput,\nbutton,\ntextarea,\nselect {\n  margin: 0;\n  font: inherit;\n}\n',
              ':root {\n  --font-family-main: consolas, "Times New Roman";\n  --font-size-m: 16px;\n  --font-line-m: 24px;\n  --font-m: var(--font-size-m) / var(--font-line-m) var(--font-family-main);\n  --font-size-l: 24px;\n  --font-line-l: 32px;\n  --font-l: var(--font-size-l) / var(--font-line-l) var(--font-family-main);\n\n  // Размеры\n  --navbar-heigth: 50px;\n}',

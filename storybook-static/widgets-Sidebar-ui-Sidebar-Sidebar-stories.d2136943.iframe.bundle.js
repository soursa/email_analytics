  ...
  [363],
  {
    './src/widgets/Sidebar/ui/Sidebar/Sidebar.stories.tsx': (
      ...
      var _Light$parameters,
        ...
        _Dark$parameters,
        _Dark$parameters2,
        ThemeDecorator_ = __webpack_require__(
              ...
              children: (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(
                shared_ui_Button_Button__WEBPACK_IMPORTED_MODULE_0__.z,
                {
                  onClick: function toggleLanguage() {
                    i18n
                      .changeLanguage('ru' === i18n.language ? 'en' : 'ru')
                      .then(
                        function () {},
                        function () {},
                      );
    ...
    './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[13].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/widgets/Sidebar/ui/Sidebar/Sidebar.module.scss':
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          '.src-widgets-Sidebar-ui-Sidebar-Sidebar-module__Sidebar--ld5FU{height:calc(100vh - var(--navbar-heigth));width:300px;background:var(--inverted-bg-color);position:relative;transition:width .2s}.src-widgets-Sidebar-ui-Sidebar-Sidebar-module__switchers--QQRIw{position:absolute;bottom:20px;display:flex;justify-content:center;align-items:center;width:100%}.src-widgets-Sidebar-ui-Sidebar-Sidebar-module__langSwitcher--i2LLP{margin-left:15px}.src-widgets-Sidebar-ui-Sidebar-Sidebar-module__collapsed--EudhC{width:110px}',
          '',
          {
            version: 3,
            sources: [
            ...
            names: [],
            mappings:
              'AAAA,+DACE,yCAAA,CACA,WAAA,CACA,mCAAA,CACA,iBAAA,CACA,oBAAA,CAGF,iEACE,iBAAA,CACA,WAAA,CACA,YAAA,CACA,sBAAA,CACA,kBAAA,CACA,UAAA,CAGF,oEACE,gBAAA,CAGF,iEACE,WAAA',
            sourcesContent: [
          ...
          (___CSS_LOADER_EXPORT___.locals = {
            ...
            langSwitcher:
              'src-widgets-Sidebar-ui-Sidebar-Sidebar-module__langSwitcher--i2LLP',
            collapsed:
